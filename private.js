...
const HDPublicKey = require('./public'); // using modified version with fewer deps and functions
...
class HDPrivateKey {
  ...
  constructor(options) {
    ...
    this.childIndex = 0;
    this.chainCode = Buffer.alloc(32, 0x00); // taken from protocol/consensus.js ZERO_HASH
    this.privateKey = Buffer.alloc(32, 0x00); // taken from protocol/consensus.js ZERO_HASH
   ...
   */
    ...
    /*
     * trimmed out for airdrop lightweight version
  ...
  */
  ...
  /*
   * Trimmed out for airdrop web use
  toWriter(bw, network) {
