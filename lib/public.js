...
class HDPublicKey {
  ...
  constructor(options) {
    ...
    this.childIndex = 0;
    this.chainCode = Buffer.alloc(32, 0x00); // copied from consensus ZERO_HASH
    this.publicKey = Buffer.alloc(32, 0x00); // copied from consensus ZERO_HASH
  ...
  /*
   * not needed for airdrop web use
